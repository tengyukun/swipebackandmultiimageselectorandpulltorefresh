...
import com.tyk.pulltorefresh.pullableview.Pullable;
 ...
 * @author tyk
 */
public class PullToRefreshLayoutUp extends RelativeLayout {
	...
	public PullToRefreshLayoutUp(Context context) {
		super(context);
		initView(context);
	}

	public PullToRefreshLayoutUp(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}

	public PullToRefreshLayoutUp(Context context, AttributeSet attrs, int defStyle) {
...
//			refreshingView.startAnimation(refreshingAnimation);
			...
			((ImageView) refreshingView).setImageResource(+R.anim.paobuloading);
			anim = (AnimationDrawable) ((ImageView) refreshingView).getDrawable();
			anim.start();
	...
	private class AutoRefreshAndLoadTask extends AsyncTask<Integer, Float, String> {
		...
		protected void onPostExecute(String result) {
			...
			// 刷新操作
			if (mListener != null)
				mListener.onRefresh(PullToRefreshLayoutUp.this);
			hide();
		}
	...
	public interface OnRefreshListener {
		 ...
		 * 刷新操作
		 */
		void onRefresh(PullToRefreshLayoutUp pullToRefreshLayout);

		/**
		 * 加载操作
		 */
		void onLoadMore(PullToRefreshLayoutUp pullToRefreshLayout);
	}
